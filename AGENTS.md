...
| `README.md` | ❌ 作废 | 旧学习项目说明，M2 后按新定位重写 |
| `ROADMAP.md` | ❌ 作废 | 旧学习路线图，与本项目无关 |
| `step_doc/`、`notes/` | ❌ 历史存档 | 禁止参考 |
| `rag_kb/`、`app/`、`demo.py`、`test_py/` | ❌ 待删除旧代码 | 禁止参考其架构与实现，不在其上续写 |
...
- 遵循设计文档第 13 节迁移与范围：旧目录按计划删除，不保留兼容层。
